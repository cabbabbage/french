...
export function filterCandidatesByCapabilities(candidates, capabilities) {
...
export function loadUserCapabilities() {
...
export function persistUserCapabilities(capabilities) {
    if (typeof window === 'undefined') {
        return;
    }
    try {
